...
export default function SignUpScreen({ navigation }) {
    ...
    return (
        <KeyboardAvoidingView style={[global.container,global.bgColorBlue,global.paddingContainer]}>
                        <TouchableWithoutFeedback style={[global.container]}  onPress={Keyboard.dismiss}>
                            <View style={[global.container]}>
                                ...
                                <Item rounded  style={[styles.inputContainer]} >
                                    <Input secureTextEntry={true} placeholder='Mot de passe' style={[styles.inputLogin]} />
                                </Item>
