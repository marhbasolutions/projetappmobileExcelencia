...
export default function HabitationScreen({ navigation,handleInput ,ColorBack}) {
    ...
    const renderFormComponent2 = () => (
        ...
        <View  >
            ...
            <Item style={styles.loginFormTextInput} >
                <Input placeholder='Valeur batiment' />
            </Item>

            <Item style={styles.loginFormTextInput} >
                <Input placeholder='Valeur Contenu' />
            </Item>
            ...
            <Item style={styles.loginFormTextInput} >
                ...
                >
                    <Picker.Item label="Categorie" value="key0" />
                    <Picker.Item label="Villa" value="key1" />
                    <Picker.Item label="Maison" value="key2" />
                    <Picker.Item label="Appartement" value="key3" />
                </Picker>
            </Item>
            ...
            <Item style={styles.loginFormTextInput} >
                <Picker
                    ...
                    selectedValue={0}
                >
                    <Picker.Item label="Type Priorite" value="key0" />
                    <Picker.Item label="Location" value="key1" />
                    <Picker.Item label="Prioritaire" value="key2" />
                </Picker>
            </Item>
