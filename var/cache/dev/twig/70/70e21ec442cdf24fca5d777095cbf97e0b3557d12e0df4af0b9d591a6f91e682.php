...
class __TwigTemplate_655e5ea6522f117bbddf99294268b51035104fe27da2cf2dabb19f3a93b3fb26 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "FrameworkBundle:Form:form_help.html.php", "/Applications/MAMP/htdocs/projetappmobileExcelencia/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
