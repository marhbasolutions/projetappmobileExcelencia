...
return [
    ...
    'auth_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::index'], [], [['text', '/mobile/login']], [], []],
    'categories_services_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::servicesCategories'], [], [['text', '/mobile/getcategoriesservices']], [], []],
    'services_by_categorie_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::servicesByCategory'], [], [['text', '/mobile/getservicesbycategory']], [], []],
    'agencies_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::agencies'], [], [['text', '/mobile/getagencies']], [], []],
    'number_agencies_by_city_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::numberAgenciesByCity'], [], [['text', '/mobile/getnumberagenciesbycity']], [], []],
    'agencies_by_city_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::agenciesByCity'], [], [['text', '/mobile/getagenciesbycity']], [], []],
    'create_rdv_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::cerateRdv'], [], [['text', '/mobile/createrdv']], [], []],
    'contrats_by_user_mobile' => [[], ['_controller' => 'App\\Controller\\Api\\ApiController::contratsByUser'], [], [['text', '/mobile/getcontratsbyuser']], [], []],
